...
s13_lims %>%
  ...
  geom_segment(
    aes(y = s3_ll, yend = s3_ul, size = "sim2"),
    width = 0.1
  ) +
...
saveRDS(simid_sel, here::here("inst", "cal", "sim2_simid_sel.rds"))
...
saveRDS(sel_lhs_lims, here::here("inst", "cal", "sim2_sel_lhs_limits.rds"))
