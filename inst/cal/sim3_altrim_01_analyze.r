...
lhs_groups <- readRDS(here::here("burnin/cal/", picksim, "lhs_sim3_altrim.rds"))
...
saveRDS(
  altrim_analysis_inputs,
  here::here("inst", "cal", "altrim_analysis_inputs.rds")
)
