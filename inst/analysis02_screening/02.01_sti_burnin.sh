...
#SBATCH --export=ALL,NSIMS=1,NSTEPS=3120,ARRIVE_RATE_ADD_PER20K=1.285,STI_SCREEN_TYPE=burnin,STI_SCREEN_KISS_EXPOSURE=FALSE,STARTTIME=1,SIMDIR=~/scratch/ScreenEpi-STI_BURNIN
